...
class VersetFavAdapter(var msg: List<Verset>):RecyclerView.Adapter<VersetFavAdapter.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var viewObj = LayoutInflater.from(parent.context).inflate(R.layout.verset_fav_item, parent, false)
    ...
    override fun onBindViewHolder(holder: VersetFavAdapter.ViewHolder, position: Int) {
